  ...
  return (
    <div className="share">
      <div className="share__top">
        ...
        <div className="share__top__search">
          {skeleton ? (
            ...
            <input
              onFocus={() => setShowCreateShare(true)}
              type="text"
      ...
      <div className="share__bottom">
        <div className="share__bottom__icon" onClick={() => setShowError(true)}>
          {skeleton ? (
            <LoadingSkeleton />
          ) : (
            <>
      ...
      {showError && (
        <ErrorMesssage
          ...
          message={"Chức năng này tui không có làm hihi!"}
        />
      )}
      {showSpinner && <Spinner />}
    </div>
